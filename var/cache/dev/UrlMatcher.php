...
return [
    false, // $matchHost
    [ // $staticRoutes
        '/api/compteNewPartenaire' => [[['_route' => 'creation_compte_NewPartenaire', '_controller' => 'App\\Controller\\CompteController::nouveauCompte'], null, ['POST' => 0], null, false, false, null]],
        '/api/comptePartenaireEx' => [[['_route' => 'compte_partenaire_ex', '_controller' => 'App\\Controller\\CompteController::comptePartenaireExistant'], null, null, null, false, false, null]],
